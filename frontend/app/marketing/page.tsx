...
export default function MarketingPage() {
  ...
  const loadPreviousData = async () => {
    setLoadingPrev(true);
    try {
      const res = await fetch('http://localhost:8000/api/v1/marketing/previous-data');
  ...
  const translateProduct = async (productKr: string) => {
    ...
    try {
      const res = await fetch('http://localhost:8000/api/v1/marketing/translate-product', {
        method: 'POST',
  ...
  const runStep2 = async () => {
    ...
    try {
      const res = await fetch('http://localhost:8000/api/v1/marketing/step2-init', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
  ...
  const applyOverlay = async () => {
    try {
      const res = await fetch('http://localhost:8000/api/v1/marketing/overlay', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
  ...
  const runStep3 = async () => {
    ...
    try {
      const res = await fetch('http://localhost:8000/api/v1/marketing/step3-generate', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
  ...
  const runStep4 = async () => {
    ...
    try {
      const res = await fetch('http://localhost:8000/api/v1/marketing/step4-memo', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
  ...
  const runStep5 = async () => {
    ...
    try {
      const res = await fetch('http://localhost:8000/api/v1/marketing/step5-video', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          brand: step1.brand, product: step1.product,
